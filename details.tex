...
\renewcommand{\website}{skyecas.github.io}
\renewcommand{\githubusername}{skyecas}
...
{%
\begin{itemize}[leftmargin=*, labelsep=-0.1em, noitemsep]
    \item Produced a Level 3 Extended Project Qualification to a high standard titled \href{https://skyecas.github.io/assets/pdf/EPQ.pdf}{`Is There A Possibility of Extrasolar Habitation?'}, assessing the habitability of the TRAPPIST-1 system and its seven Earth-sized exoplanets orbiting an M8V ultracool dwarf star.
\end{itemize}
}
...
\addproject{MAAS Release Automation Bot}{code}
{Canonical}{2025-02--Present}
{\iflean A Temporal-based bot that automates MAAS's entire release process end-to-end; orchestrating version bumps, deb and snap builds, GPG signing, Launchpad PPA publishing, Jenkins system tests, and SolQA validation across durable, resumable workflows.\else Principal engineer behind an internal Temporal-based bot that automates the MAAS release process from end to end. Orchestrates a durable, resumable pipeline spanning GitHub version bumps, LXD-driven deb builds, GPG artefact signing, Launchpad PPA creation and publishing, Snapcraft channel promotion, parallel Jenkins system-test execution, and SolQA testplan creation with approval polling; closing out with automated release-note generation and Discourse announcements. Built with Google OIDC worker authentication, dry-run support throughout, and Launchpad object-refresh polling for long-running publish waits, turning a multi-day manual release into a single self-driving workflow.\fi}
{}
...
{https://github.com/skyecas/Skiylia}
...
{https://skyecas.github.io/assets/pdf/TransitDissertation.pdf}
...
{https://skyecas.github.io/assets/pdf/GWProjectFinalReport.pdf}
...
{https://skyecas.github.io/assets/pdf/EPQ.pdf}
\fi
